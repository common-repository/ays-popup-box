...
class Ays_Pb {
	...
	private function define_admin_hooks() {
        ...
        //Add action to update plugin options
	...
	private function define_public_hooks() {
        ...
        /*
         * Add initialized html of popup to head action
         */
        if(!isset($_COOKIE['ays_popup_cookie'])){
            $this->loader->add_action('wp_head', $plugin_public, 'ays_generate_popup');
        }
        /*
         * Setting COOKIES on init
         */
        $this->loader->add_action('init', $plugin_public, 'ays_set_cookie');
